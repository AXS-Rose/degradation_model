...
from .src import (
    ThModel_Extended_aramis,
    ThModel_Extended_new,
...
class Estimador2_aramis:
    def __init__(
        ...
        **Estim_kwargs:
        ...
        self.modelo_th = ThModel_Extended_aramis(**Model_kwargs)
...
class Estimador2_new:
    def __init__(
        ...
        **Estim_kwargs:
        ...
        # Modelos de la curva y sus inversa
        self.modelo_th = ThModel_Extended_new(**Model_kwargs)
        self.modelo_th.fit_inverse(False)
...
class Estimador_cuant(Estimador2_aramis):
    def __init__(
        self,
        min_estimation_points: int,
        conserved_points: int,
